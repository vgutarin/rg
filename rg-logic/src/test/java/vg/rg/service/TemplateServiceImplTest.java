...
class TemplateServiceImplTest {
    ...
    @Test
    void create_validModel_returnsSavedModel() {
    ...
    void update_existingModel_returnsUpdatedModel() {
        ...
        var entityId = modelId.getLongValue();
    ...
    @Test
    void update_missingEntity_throwsEntityNotFoundException() {
    ...
    @Test
    void getAll_existingEntities_returnsMappedModels() {
