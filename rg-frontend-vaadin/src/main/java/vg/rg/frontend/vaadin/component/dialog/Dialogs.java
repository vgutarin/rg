 ...
 * workspace form dialogs differ in fields, validation and error handling, so a common abstraction
...
public final class Dialogs {
     ...
     */
    public static Prompt confirmDeletion(LocalizationService localization,
                                         String titleKey,
                                         String messageKey,
                                         String confirmKey,
                                         String cancelKey,
