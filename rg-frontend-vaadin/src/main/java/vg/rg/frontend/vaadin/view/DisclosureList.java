 ...
 */
class DisclosureList extends Div {
     ...
     */
    static final String LIST = "disclosure-list";

    /** One entry: the header row plus its collapsible panel. Carries the zebra striping and divider. */
    static final String ITEM = "disclosure-item";

    /** Present on an entry whose panel is open. Drives both the panel and the chevron rotation. */
    static final String ITEM_OPEN = "disclosure-item--open";

    /** The tappable header row. */
    static final String ROW = "disclosure-row";

    static final String ROW_TEXT = "disclosure-row__text";
    static final String ROW_NAME = "disclosure-row__name";
    static final String ROW_META = "disclosure-row__meta";

    /** An informational glyph in the header, present only when it applies. See {@link #addItem}. */
    static final String ROW_MARKER = "disclosure-row__marker";

    /** The disclosure chevron. */
    static final String ROW_ICON = "disclosure-row__icon";

    static final String ROW_PANEL = "disclosure-row__panel";
    static final String ROW_PANEL_INNER = "disclosure-row__panel-inner";

    /** Applied by a caller to a row of management actions inside a panel: side by side, equal width. */
    static final String ROW_ACTIONS = "disclosure-row__actions";

    /** Applied by a caller to a panel's leading free-text paragraph. */
    static final String DETAIL_DESCRIPTION = "disclosure-detail__description";

    /** Applied by a caller to a container of {@link #detailRow} entries. */
    static final String DETAIL_META = "disclosure-detail__meta";

    static final String DETAIL_ROW = "disclosure-detail__row";
    static final String DETAIL_HEADING = "disclosure-detail__heading";
    static final String DETAIL_ICON = "disclosure-detail__icon";
    static final String DETAIL_LABEL = "disclosure-detail__label";
    static final String DETAIL_VALUE = "disclosure-detail__value";
    static final String DETAIL_VALUE_MONO = "disclosure-detail__value--mono";
     ...
     */
    Div addItem(Object key, String title, String meta, Component... markers) {
        var item = new Div();
     ...
     */
    static Div detailRow(VaadinIcon icon, String label, String value, boolean monospace) {
        var row = new Div();
