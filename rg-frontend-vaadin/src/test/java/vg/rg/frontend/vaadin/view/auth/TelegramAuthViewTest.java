package vg.rg.frontend.vaadin.view.auth;
...
class TelegramAuthViewTest {
    ...
    void authenticate_authorizedOutcome_installsPrincipal() {
        var principal = new AuthenticatedUserPrincipal(
                new UniqueId(1234L), "Test User", Set.of("workspace:owner"), true,
    ...
    private AuthenticatedUserPrincipal principal(UniqueId userUniqueId) {
        return new AuthenticatedUserPrincipal(
                userUniqueId, "Test User", Set.of("workspace:owner"), true, AuthenticationFlow.TELEGRAM);
    }
